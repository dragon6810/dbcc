...
#define LEXER_TOKENTYPE_STARTOFENUM LEXER_TOKENTYPE_EOF
    ...
    #define LEXER_TOKENTYPE_STARTOFPREPROC LEXER_TOKENTYPE_DEFINE
        ...
        #define LEXER_TOKENTYPE_STARTOFPREPROCCOND LEXER_TOKENTYPE_IFDEF
        #define LEXER_TOKENTYPE_ENDOFPREPROCCOND LEXER_TOKENTYPE_IFNDEF
...
typedef enum
{
    ...
    LEXER_TOKENTYPE_INTCONSTANT,   /* [constant]       */
    LEXER_TOKENTYPE_FLOATCONSTANT, /* '[character]'    */
